...
public class TC8 {
	...
	//click on the check boxes which u want to delete
		WebElement objCB=Driver.findElement(By.xpath("html/body/div/div[2]/form/table/tbody/tr[1]/td[1]/input"));
		objCB.click();
		WebElement objCB1=Driver.findElement(By.xpath("html/body/div/div[2]/form/table/tbody/tr[2]/td[1]/input"));
		objCB1.click();
		WebElement objCB2=Driver.findElement(By.xpath("html/body/div/div[2]/form/table/tbody/tr[3]/td[1]/input"));
		objCB2.click();
		WebElement objCB3=Driver.findElement(By.xpath("html/body/div/div[2]/form/table/tbody/tr[4]/td[1]/input"));
		objCB3.click();
